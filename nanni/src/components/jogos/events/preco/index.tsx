        ...
        <div className={styles["jogo-preco"]}>
            <button 
                ...
                onClick={handleComprar}>
                    <p>{preco} R$</p>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className={styles["jogo-preco-principal-icone"]}>
            ...
            <button 
                ...
                onClick={handleDemo}>
                    <p>Baixar Demo</p>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className={styles["jogo-preco-demo-icone"]}>
                        {/* Font Awesome Free 7.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc. */}
