...
export function JogoPreco({
  ...
  const errorPreco = !isFree && preco?.toFixed(2) === undefined; // Caso haja algum problema com preço
    ...
    <div className={styles["jogo-preco"]}>
      {!errorPreco && (
        <button
          ...
          onClick={onComprar}
        >
          <p>{isFree ? "Baixar" : preco?.toFixed(2)}</p>
          <svg
